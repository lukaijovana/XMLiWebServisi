 ...
 *       &lt;sequence>
 *         &lt;element name="Duznik" type="{http://www.informatika.ftn.uns.ac.rs/mt103}TUcesnik"/>
 *         &lt;element name="Primalac" type="{http://www.informatika.ftn.uns.ac.rs/mt103}TUcesnik"/>
...
public class Mt103 {
    ...
    protected TUcesnik duznik;
    @XmlElement(name = "Primalac", required = true)
    protected TUcesnik primalac;
     ...
     *     
     */
    public void setDuznik(TUcesnik value) {
        this.duznik = value;
    }
     ...
     *     
     */
    public void setPrimalac(TUcesnik value) {
        this.primalac = value;
    }
