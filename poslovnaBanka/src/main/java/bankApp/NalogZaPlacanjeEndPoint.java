...
public class NalogZaPlacanjeEndPoint {
	...
	@Autowired
	public NalogZaPlacanjeEndPoint(NalogServisImpl nalogService, NalogKorisnikaServisImpl korisnickiNalogService, BankarskiNalogServisImpl nalogBankeService) {
	...
	private void rtgs(Nalog nalog) throws Exception {
		...
		List<BankarskiNalogEntity> naloziBanaka = bankarskiNalogServis.findAll();
	...
	public PrimiNalog getNalogZaPrenosRequest(@RequestPayload PosaljiNalog request) {
		...
		NalogZaPlacanjeEntity nalog = new NalogZaPlacanjeEntity();
